...
//             // Collect unique assignees from all processes
//             const assigneeMap = new Map<string, TaskAssigneeDTO>();
//             let totalComments = 0;
//             let totalAttachments = task.attachments?.length || 0;

//             for (const proc of task.process || []) {
//                 totalAttachments += proc.attachments?.length || 0;
//                 totalComments += proc.comments?.length || 0;

//                 for (const assignee of proc.assignee || []) {
//                     if (assignee && typeof assignee === 'object') {
//                         const user = assignee as any;
