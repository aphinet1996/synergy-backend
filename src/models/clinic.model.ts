...
//     setup: setupSchema,
//     coperateIdentity: [serviceItemSchema],
//     website: [serviceItemSchema],
//     socialMedia: [serviceItemSchema],
//     training: [serviceItemSchema],
// }, { _id: false });
...
// clinicSchema.statics.isClinicExist = async function(name: { en: string; th: string }): Promise<boolean> {
...
// // Timeline item schema (with _id for individual updates)
...
// Sub-schemas without type inference to avoid complexity
const serviceItemSchema = new Schema(
    {
        name: { type: String, required: true },
        amount: { type: Number, required: true, min: 0 },
