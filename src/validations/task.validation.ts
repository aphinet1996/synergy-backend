...
const workloadSchema = z.object({
    video: z.array(workloadItemSchema).default([]),
    website: z.array(workloadItemSchema).default([]),
    image: z.array(workloadItemSchema).default([]),
    shooting: z.array(workloadItemSchema).default([]),
});
